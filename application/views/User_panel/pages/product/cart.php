...
<?php echo form_open($panel_path.'products/update_all'); ?>
        ...
        <tr>
                <td>
				 ...
				 <td class="text-left"><div class="input-group btn-block" style="max-width: 200px;">
                  <?php echo form_input(array('name' => $i.'[qty]', 'value' => $items['qty'], 'id'=> 'qty_'.$items['id'], 'maxlength' => '3', 'size' => '5' , 'class'=>"form-control")); ?>
                  <span class="input-group-btn">
                  <button type="button" data-toggle="tooltip" title="Update" class="btn btn-primary update_cart" data-productId="<?= $items['id'];?>"  data-rowid="<?php echo  $items['rowid'];?>"><i class="fa fa-refresh"></i></button>
                  <button type="button" data-toggle="tooltip" title="Remove" class="btn btn-danger remove_from_cart" data-productId="<?= $items['id'];?>"  data-rowid="<?php echo  $items['rowid'];?>"><i class="fa fa-times-circle"></i></button>
                  </span></div></td>
...
<tr>    
       ...
       <td class="right"><strong>Total</strong></td>
        ...
        <td style="text-align:right"><strong><?= array_sum($sub_bv);?></strong></td>
</tr>
            </tbody>
</table>
      ...
      <div class="buttons clearfix">
        <div class="pull-left"><a href="<?= $panel_path.'product';?>" class="btn btn-default">Continue Shopping</a></div>
      ...
      <form action="" method="post">
        ...
        <div class="form-group">
          ...
          <a href="<?= $panel_path.'product/checkout';?>" class="btn btn-primary" name="buy_btn"  onclick="return confirm('Are you sure? you wants to Submit.')">Proceed</a>
      </form>
      </div>
      </div>
  ...
  <div class="row">
    ...
    <div id="content" class="bg-page-404 col-sm-12 ">
        ...
        <div class="col-sm-12 text-center">
                ...
                <a href="<?= $panel_path.'product';?>" class="btn btn-primary" title="Continue">Continue</a>
            </div>
