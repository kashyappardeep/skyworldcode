...
<div class="row pt-2 pb-2">
        <div class="col-sm-9">
		    <h4 class="page-title">Stacking</h4>
		    <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="<?= $admin_path.'dashboard';?>">home</a></li>            
            <!--<li class="breadcrumb-item"><a href="#"></a></li>            -->
            <li class="breadcrumb-item active" aria-current="page">Stacking</li>
         </ol>
	   </div>
	   <div class="col-sm-3">
...
<h6 class="text-uppercase">Stacking</h6>
<hr>
<?php 
                  ...
                  <?php
                   ...
                   <span class="text-danger" ><?= form_error('selected_wallet');?></span>
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        <label>Amount*</label>
                        <input type="text" name="amount"  class="form-control" placeholder="Enter Amount" aria-describedby="helpId" >
                        
                    </div>
                    
                    <div class="form-group">
                        <label>Select Stacking*</label>
                        <select class="form-control" name="staking_period" id="staking_period"  required="">
                        ...
                        <span class="text-danger" ><?= form_error('staking_period');?></span>  
                     </div>
                    <?php
