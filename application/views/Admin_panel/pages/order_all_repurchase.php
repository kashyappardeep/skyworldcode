...
?>
<h6 class="text-uppercase">Staking(<?=$tt_orders?>)</h6>
<hr>
...
<div class="row">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        ...
        <form action="<?= $admin_path.'order/repurchase';?>" method="get">
             <div class="form-inline">
                <div class="form-group ">                      
                    <input type="text" Placeholder="Enter Staking id" name="id" class="form-control" value='<?= isset($_REQUEST['id']) && $_REQUEST['id']!='' ? $_REQUEST['id']:'';?>' />                      
                 </div>
                 &nbsp;
                 <div class="form-group ">                      
               ...
               <!-- <div class="form-group m-1">
                 ...
                 <a href="<?= $admin_path.'order/repurchase';?>" class="btn btn-sm">Reset</a>
        ...
        ?>
         <div align="right">
            <div class="table table-responsive"> 
                <table>
                    <tr>
                      <th>Total Staking Amount(<?=round($ttl_amnt)?>)</th>
            ...
            <table class="table table-hover">
                <thead>
                    <tr>
                        ...
                        <th>Subscription Amount (<?= $this->conn->company_info('currency');?>) </th>
                        ...
                        <td><?= $sr_no;?></td>
                         ...
                         <?php
                            if($payment_status=='Pending' || $order_status=='Pending'){
                                ?>
                           <a class="btn btn-sm btn-info" href="<?= $admin_path.'order/view_repurchse?id='.$t_data['id'];?>">View</a>
                           <!-- <a class="btn btn-sm btn-info" href="<?= $admin_path.'order/capping_view_repurchse?id='.$t_data['id'];?>" style="background-color:#d32525;">Edit</a> -->
                            <?php
                            }
                            if($payment_status=='0'){
                                ?>
