...
<div class="row pt-2 pb-2">
        <div class="col-sm-9">
            ...
            <li class="breadcrumb-item active" aria-current="page">Subscription Detail </li>
         </ol>
	   </div>
	   <div class="col-sm-3">
...
<h6 class="text-uppercase">Subscription Detail</h6>
<hr>
...
<table class="table table-hover">
        ...
        ?>
          ...
          <!--  <tr>
            ...
            <tr>
                <th>Subscription ID. </th><td>:</td><td>
                <?= $order_details->id;?>
                </td>  
            ...
            <tr>
                <th>Subscription  Status </th><td>:</td><td>
                <?= $order_status;?>
                </td>  
                 
            </tr>
            <tr>
                <th>Subscription BV </th><td>:</td><td>
                <?= $order_details->order_bv;?>
                </td>  
                 
            </tr>
            <tr>
                <th>Capping </th><td>:</td><td>
                <?= $order_details->order_capping;?>
                </td>  
            ...
            <tr>
                ...
                <td> 
                    <div class="img" style="height: 75px; width: 75px;">
                        <?php $imageURL =$product_details->imgs;?>
    ...
    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
        ...
        <form action="" method="post">
            ...
            <div class="form-group">
              ...
              <input type="number" class="form-control" name="order_amount" value="<?= $order_details->order_amount;?>">
             </div> 
             
             <div class="form-group">
              <label for="">Bonus</label>
              <input type="number" class="form-control" name="order_bonus" value="<?= $order_details->order_mrp-$order_details->order_amount;?>">
             </div> 
              <div class="form-group">
              <label for="">Capping</label>
              <section>
              <input type="number" name="capping" value="<?= $order_details->order_capping;?>" aria-describedby="helpId" style="padding:10px;">
              </section>
              <small class="text-muted"><?= form_error('payment_status');?></small>
            </div>
             <div class="form-group">
