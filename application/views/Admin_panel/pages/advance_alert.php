        ...
        <div class="card-body">
             ...
             <form action="<?= $admin_path.'advance/add-alert';?>" method="POST" enctype= "multipart/form-data" >
               ...
               <div class="form-group">
                ...
                <div class="form-group">
                 <button type="submit" class="btn btn-dark shadow-dark px-5 btn-remove" name="alert_btn"><i class="icon-lock"></i> Add Alert</button>
           ...
           $sr_no=0;
            foreach($table_data as $t_data){
                ...
                <tr>
                   ...
                   if($t_data['status']==1){
                      ?>
                   <a  href="<?= $admin_path.'advance/edit?edit_enable='.$t_data['id'];?>" class="btn btn-success">Enable</i></a>
                  <?php
                   }else{
                   ?>
                  <a  href="<?= $admin_path.'advance/edit?edit_disable='.$t_data['id'];?>" class="btn btn-danger">Disable</i></a>
                 ...
                 <?php  
                  ...
                  ?>
                    ...
                    <td> 
                    <a class="btn btn-danger" onclick="return confirm('Are you Sure? You want to delete this Alert!');"  href="<?= $admin_path.'advance/delete?alert='.$t_data['id'];?>"><i class="fa fa-trash-o    "></i></a>
                     <a class="btn btn-primary" href="<?= $admin_path.'advance/edit_alert?alert_id='.$t_data['id'];?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                    </td>
