    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
         <form action="" method="post">
             <div class="form-inline">
                 <input type="hidden"  name="income" value="<?= $source;?>" />
               ...
               <input type="hidden" name="export_income_source" value="<?= $source;?>" /> 
                 <input type="submit" name="submit" class="btn btn-sm " value="filter" /> &nbsp;  
                 <a href="<?= $admin_path.'incomes';?>?income=<?= $source;?>" class="btn btn-sm m-1" > Reset </a>
