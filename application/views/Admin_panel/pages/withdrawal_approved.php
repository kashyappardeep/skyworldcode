<div class="row pt-2 pb-2">
        <div class="col-sm-9">
		    <h4 class="page-title"> Approved Withdrwals</h4>
		    <ol class="breadcrumb">
...
<h6 class="text-uppercase"> Approved Withdrwals</h6>
<hr>
<?php 
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        <form action="<?= $admin_path.'withdrawal/approved';?>" method="post">
             <div class="form-inline">
                ...
                <a href="<?= $admin_path.'withdrawal/approved';?>" class="btn btn-sm">Reset</a>
