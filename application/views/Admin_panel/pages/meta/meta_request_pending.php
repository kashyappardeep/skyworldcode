<div class="row pt-2 pb-2">
        <div class="col-sm-9">
		    <h4 class="page-title"> Pending Meta Request</h4>
		    <ol class="breadcrumb">
...
<h6 class="text-uppercase"> Pending Meta Request</h6>
<hr>
<?php
...
<div class="row">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        <form action="<?= $admin_path.'meta/pending';?>" method="get">
             <div class="form-inline">
                 ...
                 <a href="<?=$admin_path.'eta/pending';?>"class="btn btn-sm">Reset</a>
    ...
    <table class="table table-hover">
        ...
        if($table_data){
            ...
            <tr>
                ...
                <td><a class="btn btn-sm btn-info" href="<?= $admin_path.'meta/view?id='.$t_data['id'];?>">View</a></td>                               
                <td><?= $t_data['amount'];?></td>   
