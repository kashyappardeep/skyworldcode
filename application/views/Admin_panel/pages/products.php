            ...
            foreach($table_data as $t_data){
              $product_details=$this->product->product_detail($t_data['id']);
                ...
                <tr>
                    ...
                    <td><?= $left_sale_qty;?></td>
                    <td><a  class="btn btn-danger btn-sm" onclick="return confirm('Are you Sure? You want to delete this Product!');"  href="<?= $admin_path.'product/delete?product='.$t_data['id'];?>"><i class="fa fa-trash-o    "></i>delete</a> 
                    <a class="btn btn-success btn-sm"  href="<?= $admin_path.'product/product-edit?id='.$t_data['id'];?>"><i class="fa fa-edit    ">Edit</i></a>
                    </td>
