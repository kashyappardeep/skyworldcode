<div class="row pt-2 pb-2">
        <div class="col-sm-9">
            ...
            <li class="breadcrumb-item"><a href="#">  Dummy Power</a></li>            
            <li class="breadcrumb-item active" aria-current="page">   Dummy Power </li>
         </ol>
	   </div>
	   <div class="col-sm-3">
...
<div class="row">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        <form action="<?= $admin_path.'fund/carry_detail';?>" method="get">
             <div class="form-inline">
                 ...
                 <a href="<?=$admin_path.'fund/carry_detail';?>"class="btn btn-sm">Reset</a>&nbsp;
