<?php
$package_details=$this->conn->runQuery('*','pin_details',"id='$package_id' and status='1'")[0];
?>
      ...
      <div class="card card-body">
          <form action="" method="post">
              ...
              <div class="form-group">
                ...
                <input type="text" name="rank" id="rank" value="<?= $package_details->rank;?>" class="form-control" placeholder="" aria-describedby="helpId">
                
              </div>
              <div class="form-group">
                <label for="">Bonus(%)</label>
                <input type="text" name="bonus" id="bonus" value="<?= $package_details->bonus;?>" class="form-control" placeholder="" aria-describedby="helpId">
                
              </div>
              <div class="form-group">
                <label for="">Dtp</label>
                <input type="text" name="dtp" id="dtp" value="<?= $package_details->dtp;?>" class="form-control" placeholder="" aria-describedby="helpId">
                
              </div>
                <div class="form-group">
                <label for="">Subcription</label>
                <input type="text" name="subcription" id="subcription" value="<?= $package_details->subcription;?>" class="form-control" placeholder="" aria-describedby="helpId">
