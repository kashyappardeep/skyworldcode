...
<!--End Row-->
            ...
            <?php
             ...
             <?php
                         ...
                         $total_bv=$this->conn->runQuery('SUM(product_bv*quantity) as ttl_bv','franchise_order_items',"1=1")[0]->ttl_bv;
                             ...
                             $total_bvs=$this->conn->runQuery('SUM(product_bv*quantity) as tttl_bv','order_items',"1=1")[0]->tttl_bv;
                    ...
                    <?php 
                      ...
                      if(!empty($table_data)){  
                        ...
                        foreach($table_data as $t_data){
                         ...
                         $total_bv=$this->conn->runQuery('SUM(product_bv*quantity) as ttl_bv','franchise_order_items',"f_code='$id'")[0]->ttl_bv;
                         ...
                         $total_bvs=$this->conn->runQuery('SUM(product_bv*quantity) as tttl_bv','order_items',"franchise_id='$id'")[0]->tttl_bv;
