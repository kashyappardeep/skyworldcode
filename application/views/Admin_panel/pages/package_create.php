      ...
      <div class="card card-body">
          <form action="" method="post">
              ...
              <div class="form-group">
                ...
                <input type="text" name="rank" id="rank" value="<?= set_value('rank');?>" class="form-control" placeholder="" aria-describedby="helpId">
                
              </div>
              <div class="form-group">
                <label for="">Bonus(%)</label>
                <input type="text" name="bonus" id="bonus" value="<?= set_value('bonus');?>" class="form-control" placeholder="" aria-describedby="helpId">
                
              </div>
              <div class="form-group">
                <label for="">Dtp</label>
                <input type="text" name="dtp" id="dtp" value="<?= set_value('dtp');?>" class="form-control" placeholder="" aria-describedby="helpId">
                
              </div>
                <div class="form-group">
                <label for="">Subcription</label>
                <input type="text" name="subcription" id="subcription" value="<?= set_value('subcription');?>" class="form-control" placeholder="" aria-describedby="helpId">
              ...
              <button type="submit" class="btn btn-primary btn-remove" name="add_btn">Create</button>
          </form>
      </div>
    </div>
</div>
