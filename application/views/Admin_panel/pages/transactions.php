<?php
$ttl=$this->conn->runQuery('count(id)as total','transaction',"1=1");
    ...
    <table class="table table-hover">
        ...
        if($table_data){
            ...
            <tr>
                ...
                <td><?php if($t_data['wallet_type']=='main_wallet'){echo"Main Wallet";}elseif($t_data['wallet_type']=='fund_wallet'){echo"Fund Wallet";}?></td>  
