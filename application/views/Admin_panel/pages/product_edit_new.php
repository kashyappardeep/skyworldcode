...
//echo $this->product->product_rate(21);
    ...
    $product_details_qty=$this->conn->runQuery('qty','product_skus',"post_id='$product_id'")[0];
    $p_qty=$product_details_qty->qty;
    ...
    <div class="row">
      ...
      <div class="col-lg-8">
          ...
          <div id="add_product_area">
            ...
            if($all_tabs){
                ...
                foreach($all_tabs as $tab){
                    ...
                    $c++;
                    if($type_qty!='qtys' && $type_qty!='variants'){
                    ?>
                    <li class="nav-item">
        ...
        <div class="tab-content">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group" >
                                                    ...
                                                    if($fl_type=='textarea'){
                                                        ?>
                                                        <label><?= $field->admin_display;?></label>
                                                            <textarea <?= $fl_attr;?> name="<?= $field->slug;?>" class="form-control <?= $fl_class;?>" title="<?= $field->admin_display;?>"><?= html_entity_decode($corr_val);?></textarea>
                                                        <?php
                                                    }
                                                    ...
                                                    if($fl_type=='file'){
                                                        ...
                                                        <label><?= $field->admin_display;?></label>
                                                          ...
                                                          <label>Qty</label>
                                                        <input  name="qty" value="<?= $p_qty;?>" class="form-control" Placeholder="" />
                                                        <?php
                                                    }
         ...
         <div class="form-group">
                  <button type="submit" class="btn btn-dark shadow-dark px-5 btn-remove" name="edit_btn"><i class="icon-lock"></i> Edit Product</button>
              </div> 
              </form>
      </div>
      <div class="col-lg-4">
        ...
        <div class="card ">
            ...
            <div class="card-body">
                <form action="" id="main_image_form" method="post" enctype="">
                  <img id="p_main_image" src="<?= $product_details_arr->imgs;?>" style="width:100%;">
                  <!-- <div class="form-group">
