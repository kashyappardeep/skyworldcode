...
<div class="row">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
         <form action="<?= $admin_path.'kyc/approved';?>" method="get">
             <div class="form-inline">
                 ...
                 <a href="<?=$admin_path.'kyc/approved';?>"class="btn btn-sm">Reset</a>
...
<?php
         ...
         $account_detail=$this->conn->runQuery('*','user_accounts',"1=1");
        ...
        if($table_data){
            ...
            <tr>
                ...
                <br>
                 ...
                 <td><?php if($t_data['kyc_status']=='approved'){ ?><a class="btn btn-sm btn-info" href="<?= $admin_path.'kyc/view?id='.$t_data['id'];?>">View Request</a><?php } ?></td>                               
               </tr>
        <?php
            }
        }
