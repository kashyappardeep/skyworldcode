...
<div class="row">
    ...
    <?php
       $node_ids=$node_id; 
                if($node_ids){
                        $_user_profile = $this->profile->profile_info($node_ids);
                ...
                <span <?php if($node_ids){ ?> data-toggle="popover1" data-trigger="hover" data-html="true" data-content="Name :<?= $_user_profile->name;?><br>Sponser Id: <?= ($sponsor_details ? $sponsor_details->name:'null');?> (<?= ($sponsor_details ? $sponsor_details->username:'null');?>)<br> Email: <?= $_user_profile->email;?><br>Join Date : <?= $_user_profile->added_on;?>" <?php } ?> >
