...
<div class="row pt-2 pb-2">
        <div class="col-sm-9">
		    <h4 class="page-title">AI Subscription Details </h4>
		    <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="<?= $admin_path.'dashboard';?>">home</a></li>            
            <li class="breadcrumb-item"><a href="#"> AI Subscription</a></li>            
            <li class="breadcrumb-item"><a href="#"> All</a></li>            
            <li class="breadcrumb-item active" aria-current="page">AI Subscription Detail </li>
         </ol>
	   </div>
	   <div class="col-sm-3">
...
<h6 class="text-uppercase">AI Subscription Detail</h6>
<hr>
...
<table class="table table-hover">
        ...
        ?>
          ...
          <!--  <tr>
            ...
            <tr>
                <th>AI Subscription ID. </th><td>:</td><td>
                <?= $order_details->id;?>
                </td>  
                 
            </tr>
            <tr>
                <th>AI Subscription capping </th><td>:</td><td>
            ...
            <tr>
                <th>AI Subscription  Status </th><td>:</td><td>
                <?= $order_status;?>
                </td>  
                 
            </tr>
            <tr>
                <th>AI Subscription BV </th><td>:</td><td>
    ...
    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
        ...
        <form action="" method="post">
            ...
            <div class="form-group">
              ...
              <?php
            if($payment_status=='Success' && $order_status=='Success'){
            ?>
