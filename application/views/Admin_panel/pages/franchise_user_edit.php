...
<?php 
                        ...
                        $profile=$this->profile->franchise_info($profile);
                    ?>
<div class="row">
      ...
      <div class="card card-body">
          <form action="" method="post" >
		               ...
		               <div class="form-group">
                                ...
                                <input type="text" name="bank_name" id="bank_name" value="<?= $profile->bank_name;?>" class="form-control" placeholder="Bank Name" aria-describedby="helpId">
                                <span class=" " ><?php echo form_error('bank_name');?></span>
                              </div>
                           
                             <div class="form-group">
                                <label for="">Account Holder Name</label>
                                <input type="text" name="account_holder_name" id="account_holder_name" value="<?= $profile->account_holder_name;?>" class="form-control" placeholder="Account Holder Name" aria-describedby="helpId">
                                <span class=" " ><?php echo form_error('account_holder_name');?></span>
                              </div>
                            
                             <div class="form-group">
                                <label for="">Account No.</label>
                                <input type="text" name="account_no" id="account_no" value="<?= $profile->account_no;?>" class="form-control" placeholder="Account No." aria-describedby="helpId">
                                <span class=" " ><?php echo form_error('account_no');?></span>
                              </div>
                            
                             <div class="form-group">
                                <label for="">Ifsc Code</label>
                                <input type="text" name="ifsc_code" id="ifsc_code" value="<?= $profile->ifsc_code;?>" class="form-control" placeholder="Ifsc Code" aria-describedby="helpId">
                                <span class=" " ><?php echo form_error('ifsc_code');?></span>
                              </div>
                            
                             <div class="form-group">
                                <label for="">Bank Branch</label>
                                <input type="text" name="bank_branch" id="bank_branch" value="<?= $profile->bank_branch;?>" class="form-control" placeholder="Bank Branch" aria-describedby="helpId">
                                <span class=" " ><?php echo form_error('bank_branch');?></span>
                              </div>
