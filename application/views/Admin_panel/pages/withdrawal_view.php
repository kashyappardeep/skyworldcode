...
<table class="table table-hover">
        ...
        ?>
            ...
            <tr> 
                ...
                $with_sts=$t_data->withdraw_status;
                if($with_sts==7){
...
<?php $reply = $this->conn->runQuery('*','reply_msg',"type='withdrawal' ORDER BY id DESC");
    ...
    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
        <form action="" method="post">
            <div class="form-group">
              ...
              <textarea name="reason" id="" class="form-control"><?= $reply[0]->reply?></textarea>
