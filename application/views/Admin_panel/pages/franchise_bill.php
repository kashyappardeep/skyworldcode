...
$vd_id=$_REQUEST['order_id'];
$order_details=$this->conn->runQuery('*','franchise_orders',"id='$vd_id'")[0];
$u_code=$order_details->f_code;
$order_ids=$order_details->id;
$total_order_amt=$order_details->order_amount;
$total_order_bv=$order_details->order_bv;
$users_details=$this->conn->runQuery('*','franchise_users',"id='$u_code'")[0];
$pkg_details1=$this->conn->runQuery('*','franchise_order_items',"order_id='$order_ids'");
	...
	<center>
        ...
        <table cellpadding="0" cellspacing="0">
                ...
                <td colspan="6">
                    <table>
						...
						$order_address=	json_decode($order_details->order_address,true);
							...
							<strong><b>Franchise Info</b></strong><br>
                               <?php echo 'Name :'.$users_details->name;?><br>
                               <?php echo 'Mobile :'.$users_details->mobile;?><br>
                               <?php echo 'Email :'.$users_details->email;?><br>
                               <?php echo 'Address :'.$users_details->address.'('.$users_details->pin_code.')';?><br>
                               <?= $users_details->city.', '.$users_details->state;?><br>
                            </td>
                        </tr>
                    </table>
                </td>
            ...
            <tr class="heading">
				...
				<td class="text-right">
                   Total Amount (<?php echo $this->conn->company_info('currency');?>)
                </td>
            </tr>
            <?php 
            $sr=0;
            foreach($pkg_details1 as $pkg_details2){
               $test[]=$pkg_details2->quantity;
            ...
            <tr class="item" >
                ...
                <td class="text-right">				 
                    <?php echo $total_price_unit[]=$pkg_details2->product_bv;?>
            ...
            <tr class="total">
                ...
                <td colspan="5">
                   ...
                   Total Amount:<?php echo $this->conn->company_info('currency');?> <?php echo  $total_order_amt=$order_details->order_amount;?><br>
                  	Total Qty : <?php  echo array_sum($test);
                  	
                  	
                  	?><br>
			Total Price / Unit : <?php  echo array_sum($total_price_unit);
