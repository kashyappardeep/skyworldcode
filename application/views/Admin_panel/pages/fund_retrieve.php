...
<div class="row pt-2 pb-2">
        <div class="col-sm-9">
		    <h4 class="page-title"> Fund Retrieve</h4>
		    <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="<?= $admin_path.'dashboard';?>">home</a></li>            
            <li class="breadcrumb-item"><a href="#">Fund</a></li>            
            <li class="breadcrumb-item active" aria-current="page"> Fund Retrieve</li>
         </ol>
	   </div>
	   <div class="col-sm-3">
...
<h6 class="text-uppercase"> Fund Retrieve</h6>
<hr>
<?php  
        ...
        <span class=" " ><?= form_error('selected_wallet');?></span>
            ...
            <div class="form-group">
             ...
             <div class="form-group">
              ...
              <textarea type="text" name="remark" id="remark" value="<?= set_value('remark');?>" class="form-control" placeholder="Enter Remark" aria-describedby="helpId"></textarea>
              <span class=" " ><?= form_error('remark');?></span>  
            </div>
            ...
            <?php
                ...
                if($edit_profile_with_otp=='yes'){
                  ...
                  <div id="action_area" style="display:<?= $display;?>"> 
                    ...
                    <button type="submit" class="btn btn-primary" name="retrieve_btn">Retrieve</button> 
                  </div>
                  <?php
                }else{
                  ?>
                   <button type="submit" class="btn btn-primary btn-remove" name="retrieve_btn" onclick="return confirm('Are you sure? you wants to Submit.')" >Retrieve</button>
                  <?php
                }
                ?>
