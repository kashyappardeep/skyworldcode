		...
		<div class="card-body">
		 <div class="card-content p-2">
		 	<div class="text-center">
		 		<img src="<?= $this->conn->company_info('logo_black');?>" class="logo-icon" alt="<?= $this->conn->company_info('company_name');?>" style="width:<?= $this->conn->company_info('logo_width');?>;height:<?php echo $this->conn-> company_info('logo_height');?>">
             </div>
			 ...
			 <div class="form-group col-6">
			   <div class="icheck-material-primary">
                ...
                <label for="user-checkbox">Remember me</label>
                  <a href="<?= base_url('forgot');?>" class="forget-pass font_color"> Forgot your password?</a>
			  </div>
			 </div>
