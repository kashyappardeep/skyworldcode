    ...
    <table class="table table-hover">
        ...
        if($table_data){
            ...
            <tr>
                ...
                <td><?= $t_data['tax_id'];?></td>
                <td>Bank Name:<?= $t_data['bank_name'];?><br>A/c Holder Name:<?= $t_data['account_holder_name'];?><br>A/c Number:<?= $t_data['account_no'];?><br>Ifsc:<?= $t_data['ifsc_code'];?><br>Branch:<?= $t_data['bank_branch'];?><br></td>
                <td><?php if($t_data['kyc_status']=='submitted'){ ?><a class="btn btn-sm btn-info" href="<?= $admin_path.'kyc/view?id='.$t_data['id'];?>">View Request</a><?php } ?><?php if($t_data['kyc_status']=='approved'){ ?>Approved<?php } ?><?php if($t_data['kyc_status']=='rejected'){ ?>Rejected<?php } ?><?php if($t_data['kyc_status']=='pending'){ ?>Not Uploaded<?php } ?></td>                               
               </tr>
        <?php
            }
        }
