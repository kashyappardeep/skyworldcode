<?php
 $notification=$this->conn->runQuery('*','notice_board',"id='$up_id'");
?>
...
<div class="row pt-2 pb-2">
        <div class="col-sm-12">
            ...
            <li class="breadcrumb-item active" aria-current="page">Edit   Alert</li>
         </ol>
	   </div>
 ...
 <?php 
    ...
    <div class="col-md-4 card bg-light">
        ...
        <div class="card-body">
             ...
             <form action="<?= $admin_path.'advance/edit_alert';?>" method="POST" enctype= "multipart/form-data" >
            ...
            <!--  <div class="form-group">
               ...
               <div class="form-group">
                     ...
                     <input type="text" class="form-control input-shadow bg-white" value="<?php echo $notification[0]->title;?>" name="title" id="title" placeholder="Enter Title here"  />
                    <?php echo form_error('title');?>
                </div>
                <div class="form-group">
                     <label for="input-11">Description</label>
                     <textarea  name="description" id="description" class="form-control" placeholder="Enter description here" ><?php echo $notification[0]->description;;?></textarea>
             ...
             <!--<div class="form-group">
                 ...
                 -->
                <div class="form-group">
                 <button type="submit" class="btn btn-dark shadow-dark px-5" name="edit_alert_btn"><i class="icon-lock"></i>Edit Alert</button>
               </div>
           </form>
        </div>
    </div>
    ...
    <table class="table">
        ...
        <!--  <th>Image   </th>-->
          ...
          if(!empty($notification)){
           $sr_no=0;
            foreach($notification as $t_data){
                $sr_no++;
                ?>
                <tr>
                    <td><?= $sr_no;?></td>
