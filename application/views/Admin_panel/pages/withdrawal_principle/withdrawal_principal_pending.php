<div class="row pt-2 pb-2">
        <div class="col-sm-9">
		    <h4 class="page-title">Principal Pending Withdrwals</h4>
		    <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="<?= $admin_path.'dashboard';?>">home</a></li>            
            <li class="breadcrumb-item"><a href="#"> Withdrwals</a></li>            
            <li class="breadcrumb-item active" aria-current="page">Principal  Pending </li>
         </ol>
	   </div>
	   <div class="col-sm-3">
...
<h6 class="text-uppercase">Principal Pending Withdrwals</h6>
<hr>
<?php
...
<div class="row">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        <form action="<?= $admin_path.'withdrawal_principal/pending';?>" method="REQUEST">
             <div class="form-inline">
                 ...
                 <a href="<?= $admin_path.'withdrawal_principal/pending';?>" class="btn btn-sm">Reset</a>&nbsp;
...
<br>
<!--<form action="<?= $admin_path.'withdrawal_principal/action_multiple';?>" method="post">
    ...
    <table class="table table-hover">
        ...
        if($table_data){
            ...
            <tr>
                ...
                <td><a class="btn btn-sm btn-info" href="<?= $admin_path.'withdrawal_principal/view?id='.$t_data['id'];?>">View</a></td>                               
