<div class="row pt-2 pb-2">
        <div class="col-sm-9">
		    <h4 class="page-title">Principal Cancelled Withdrwals</h4>
		    <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="<?= $admin_path.'dashboard';?>">home</a></li>            
            <li class="breadcrumb-item"><a href="#">Principal Withdrwals</a></li>            
...
<h6 class="text-uppercase">Principal Cancelled Withdrwals</h6>
<hr>
<?php 
...
<div class="row">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        <form action="<?= $admin_path.'withdrawal_principal/cancelled';?>" method="post">
             <div class="form-inline">
                ...
                <a href="<?= $admin_path.'withdrawal_principal/cancelled';?>" class="btn btn-sm">Reset</a>
